class GameSceneTwo extends Phaser.Scene {
  ...
  preload() {
    this.load.image("backgroundtwo", "assets/images/background2.png");
    ...
    this.load.audio("musictwo", "assets/sounds/level2.mp3");
  ...
  create() {
    ...
    //звук уровня//
    let musictwo = this.sound.add("musictwo");
    musictwo.setVolume(0.2);
    musictwo.setLoop(true);
    musictwo.play();
    ...
    function nextLevel() {
      if (this.keyScore === 1 && this.coinScore >= 33) {
        this.sound.removeByKey('musictwo');
